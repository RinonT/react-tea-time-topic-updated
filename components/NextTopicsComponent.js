...
export default function TopicsComponent({ id, title, upvotes, downvotes, upvoteTopic, downvoteTopic, archiveTopic}) {
    ...
    return (
        <article>
            <button className="archive" id={id} onClick={archiveTopic}>
